...
export default function Contact() {
  return (
    <div className="w-full h-full flex flex-row items-center justify-between">
      ...
      <div className='w-1/2 grid grid-cols-3 gap-3 p-4'>
        <BlackIconWrapper
          icon={faInstagram}
          target='https://www.instagram.com/chemicalmyth/'
        />
        <RedIconWrapper icon={faXTwitter} target="https://x.com/MythChemical" />
        <BlackIconWrapper icon={faYoutube} target="" />
        <RedIconWrapper icon={faLinkedinIn} target="www.linkedin.com/in/mohneesh-naidu-780476251/" />
        <BlackIconWrapper icon={faGithub} target="https://github.com/certainlyMohneeesh" />
        <RedIconWrapper icon={faEnvelope} target="certainlymohneesh@gmail.com" isEmail />
      </div>
    </div>
  )
}
